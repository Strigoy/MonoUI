...
m_ActionBars.MouseOverBind = function()
	...
	if not bind.loaded then
		...
		function bind:Listener(key)
			...
			if not self.spellmacro or self.spellmacro=="PET" or self.spellmacro=="STANCE" or self.spellmacro=="MULTICASTSUMMONSPELL" or self.spellmacro=="MULTICASTRECALL" then
...
SlashCmdList.MOUSEOVERBIND = function() m_ActionBars.MouseOverBind() end
