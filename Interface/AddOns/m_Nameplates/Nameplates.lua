...
--[[ 
	...
	hp.tar:SetPoint("TOPLEFT", hp, "TOPLEFT", -1, 1)
	hp.tar:SetPoint("BOTTOMRIGHT", hp, "BOTTOMRIGHT", 1, -1)
	hp.tar:SetBackdrop({edgeFile = "Interface\\ChatFrame\\ChatFrameBackground", edgeSize = 1.2,
						insets = {left = -6, right = 6, top = 6, bottom = -6}})
	hp.tar:SetBackdropColor(0, 0, 0)
	hp.tar:SetBackdropBorderColor(0, 0, 0)   
 ]]
