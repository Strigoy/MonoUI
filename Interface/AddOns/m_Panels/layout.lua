local RaidBG = false -- toggle raid background on and off
----------------------------------------------------------------------------------------------------
---------------------------------------   Set of textures   ----------------------------------------
----------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------
	...
	adv_panel ("RightBG",-80-gap,23,xadj+330,bch,UIParent,"BOTTOMRIGHT","BOTTOMRIGHT",UIParent,
		...
		adv_panel ("Consum_pnl",-252-xadj,9,71,140,RightBG,"BOTTOMRIGHT","BOTTOMRIGHT",UIParent,
					def_back,def_border,"BACKGROUND",{0,0,0,0},{0,0,0,0})
		adv_panel ("DM_pnl",0,-1,xadj+165,140,Consum_pnl,"BOTTOMLEFT","BOTTOMRIGHT",UIParent,
