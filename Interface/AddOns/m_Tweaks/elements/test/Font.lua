...
if LSM then
	LSM:Register(LSM.MediaType.FONT, "Calibri", cfg.normal_font, LOCALE_MASK)
	LSM:Register(LSM.MediaType.STATUSBAR, "Smooth", cfg.statusbar)
end ]]